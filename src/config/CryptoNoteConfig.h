...
// Copyright (c) 2018, The Aryacoin Project
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1b40c8;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1200000000000);
...
For example:
AryaCoind --print-genesis-tx --genesis-block-reward-address aYAv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
*/
const char GENESIS_COINBASE_TX_HEX[] = "012801ff000180c8afa0250252c3141ef61abe830eb628d2ba0857a9bc46d04dbc4b0b8efdd64280beae5a2121012762e7ee86e98d405ce8299c8657dfc12c9e877f8ca8483ac6a297eaf7d0c322";

static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in AryaCoind. It is used to know what timestamp
...
/* The mixin to use by default with zedwallet and arya-service */
...
const char     CRYPTONOTE_NAME[]                             = "AryaCoin";
...
const char     LATEST_VERSION_URL[]                          = "http://mrdigicoin.eu";
const std::string LICENSE_URL                                = "https://github.com/Aryacoin/aryacoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb5, 0x0c, 0x4a, 0x6c, 0xcf, 0xd2, 0x57, 0x41, 0xf9, 0x6b, 0x91, 0xa4, 0xb6, 0xc1, 0x4c, 0xe9  }
};
